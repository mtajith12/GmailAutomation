...
import com.gmail.TestSuiteBase.SuiteBase;
...
public class ScreenshotUtility implements ITestListener{	
	...
	public void onTestSuccess(ITestResult tr) {
		...
		if(SuiteBase.PropertyUtil.getProperty("screenShotOnPass").equalsIgnoreCase("yes"))
		{
	...
	public void onTestFailure(ITestResult tr) {		
		...
		if(SuiteBase.PropertyUtil.getProperty("screenShotOnFail").equalsIgnoreCase("yes"))
		{
